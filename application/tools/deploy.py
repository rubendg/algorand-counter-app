...
parser.add_option(
    ...
    "--descriptor",
    dest="descriptor",
    help="read deployment descriptor from FILE",
    type="str",
    metavar="FILE",
    default=None,
)
parser.add_option(
    "-n", "--network", dest="network", default="default", help="the target network"
)
...
if __name__ == "__main__":
    ...
    if options.descriptor:
        with open(options.descriptor, "r") as f:
            ...
            app_id, app_address, tx_id = deploy_from_descriptor(
                client, address, signer, descriptor
            )
    else:
